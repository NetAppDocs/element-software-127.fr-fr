...
[role="lead"]
L'interface utilisateur Web du logiciel Element utilise la `ListSnapMirrorNetworkInterfaces` méthode pour répertorier toutes les interfaces SnapMirror disponibles sur un système ONTAP distant.
