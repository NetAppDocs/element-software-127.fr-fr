...
[role="lead"]
Vous pouvez utiliser la `ModifyVolumeAccessGroupLunAssignments` méthode pour définir des affectations de LUN personnalisées pour des volumes spécifiques.
