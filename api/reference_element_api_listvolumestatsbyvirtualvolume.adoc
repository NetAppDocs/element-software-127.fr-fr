...
[role="lead"]
Vous pouvez utiliser `ListVolumeStatsByVirtualVolume` la méthode pour répertorier les statistiques de volume pour tous les volumes du système associés à un volume virtuel. Les statistiques sont cumulatives à partir de la création du volume.
