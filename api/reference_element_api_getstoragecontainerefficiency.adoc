...
[role="lead"]
Vous pouvez utiliser la `GetStorageContainerEfficiency` méthode pour récupérer des informations sur l'efficacité d'un conteneur de stockage de volume virtuel.
