...
[role="lead"]
Vous pouvez utiliser `ListBulkVolumeJobs` la méthode pour obtenir des informations sur chaque opération de lecture ou d'écriture de volume en bloc qui se produit dans le système.
