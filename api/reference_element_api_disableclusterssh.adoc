...
[role="lead"]
Vous pouvez utiliser la `DisableClusterSsh` méthode pour désactiver le service SSH pour l'ensemble du cluster de stockage. Lorsque vous ajoutez des nœuds au cluster de stockage, ce paramètre hérite de ce paramètre au niveau du cluster.
