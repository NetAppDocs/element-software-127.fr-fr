...
[role="lead"]
Vous pouvez utiliser `ListAccounts` pour obtenir la liste complète des comptes de locataires de stockage, avec la prise en charge facultative de la pagination. Les comptes Element permettent l'accès aux volumes.
