...
[role="lead"]
L'interface utilisateur web du logiciel Element utilise la `ListSnapMirrorEndpoints` méthode pour lister tous les terminaux SnapMirror avec lesquels le cluster de stockage Element communique.
