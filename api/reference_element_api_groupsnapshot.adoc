...
[role="lead"]
L'objet groupSnapshot contient des informations sur un instantané pour un groupe de volumes. Vous pouvez utiliser la `ListGroupSnapshots` méthode API pour récupérer les informations de snapshot de groupe.
