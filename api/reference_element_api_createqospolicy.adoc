...
[role="lead"]
Vous pouvez utiliser `CreateQoSPolicy` la méthode pour créer un objet QoSPolicy que vous pourrez ensuite appliquer à un volume lors de sa création ou de sa modification. Une politique de QoS possède un ID unique, un nom et des paramètres de QoS.
