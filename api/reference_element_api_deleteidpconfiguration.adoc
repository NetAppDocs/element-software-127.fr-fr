...
[role="lead"]
Vous pouvez utiliser la `DeleteIdpConfiguration` méthode pour supprimer la configuration existante d'un IDP tiers pour le cluster. La suppression de la dernière configuration IDP supprime le certificat SAML Service Provider du cluster.
