...
[role="lead"]
Vous pouvez utiliser la `SetLoginBanner` méthode pour configurer la bannière Conditions d'utilisation que les utilisateurs voient lorsqu'ils se connectent à l'interface Web d'Element.
...
* `false`: La bannière Conditions d'utilisation n'est pas affichée lors de la connexion à l'interface Web.
