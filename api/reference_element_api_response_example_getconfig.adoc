...
[role="lead"]
La `GetConfig` méthode renvoie une réponse similaire à l'exemple suivant. Du fait de sa longueur, la réponse contient des informations relatives à un seul nœud du cluster.
