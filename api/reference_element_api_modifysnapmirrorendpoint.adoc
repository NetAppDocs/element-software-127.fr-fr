...
[role="lead"]
L'interface utilisateur Web du logiciel Element utilise `ModifySnapMirrorEndpoint` la méthode pour modifier le nom et les attributs de gestion d'un noeud final SnapMirror.
