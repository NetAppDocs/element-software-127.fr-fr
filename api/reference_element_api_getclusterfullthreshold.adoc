...
[role="lead"]
Vous pouvez utiliser la `GetClusterFullThreshold` méthode pour afficher les étapes définies pour les niveaux de plénitude du cluster. Cette méthode renvoie toutes les mesures de remplissage pour le cluster.
