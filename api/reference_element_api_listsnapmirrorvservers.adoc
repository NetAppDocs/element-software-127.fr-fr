...
[role="lead"]
L'interface utilisateur web du logiciel Element utilise la `ListSnapMirrorVservers` méthode pour lister tous les vServers SnapMirror disponibles sur un système ONTAP distant.
