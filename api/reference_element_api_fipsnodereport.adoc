...
[role="lead"]
L'objet fipsNodeReport contient des informations sur la prise en charge de FIPS 140-2 pour un seul nœud du cluster de stockage. Vous pouvez récupérer ces informations à l'aide de la `GetFipsReport` méthode.
