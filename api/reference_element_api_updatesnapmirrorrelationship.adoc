...
[role="lead"]
L'interface utilisateur web du logiciel Element utilise `UpdateSnapMirrorRelationship` la méthode pour faire du volume de destination dans une relation SnapMirror un miroir à jour du volume source.
