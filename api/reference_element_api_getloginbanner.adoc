...
[role="lead"]
Vous pouvez utiliser `GetLoginBanner` la méthode pour obtenir la bannière Conditions d'utilisation actuellement active que les utilisateurs voient lorsqu'ils se connectent à l'interface Web d'Element.
