...
[role="lead"]
Vous pouvez utiliser `EnableMaintenanceMode` la méthode pour préparer un nœud de stockage à des fins de maintenance. Les scénarios de maintenance incluent toutes les tâches qui requièrent la mise hors tension ou le redémarrage du nœud.
