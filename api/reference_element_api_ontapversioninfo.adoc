...
[role="lead"]
L'objet ontapVersionInfo contient des informations sur la version d'API du cluster ONTAP dans une relation SnapMirror. L'interface utilisateur Web d'Element utilise `GetOntapVersionInfo` la méthode API pour obtenir ces informations.
