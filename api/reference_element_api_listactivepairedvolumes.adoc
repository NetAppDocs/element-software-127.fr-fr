...
[role="lead"]
Vous pouvez utiliser la `ListActivePairedVolumes` méthode pour répertorier tous les volumes actifs couplés à un volume. Cette méthode renvoie des informations sur les volumes avec des associations actives et en attente.
