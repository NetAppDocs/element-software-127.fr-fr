...
[role="lead"]
Vous pouvez utiliser la `GetDriveConfig` méthode pour obtenir des informations sur le disque pour le nombre attendu de disques de bloc et de tranche, ainsi que le nombre de disques de bloc et de coupes actuellement connectés au nœud.
