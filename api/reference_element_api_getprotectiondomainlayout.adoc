...
[role="lead"]
Vous pouvez utiliser `GetProtectionDomainLayout` la méthode pour renvoyer toutes les informations de domaine de protection d'un cluster, y compris le châssis et le domaine de protection personnalisé dans lequel se trouve chaque nœud.
