...
[role="lead"]
L'objet hardwareInfo contient des informations détaillées sur le matériel et l'état de chaque nœud du cluster. Vous pouvez récupérer ces informations avec la `GetHardwareInfo` méthode API.
