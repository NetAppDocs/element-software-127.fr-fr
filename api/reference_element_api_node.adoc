...
[role="lead"]
L'objet nœud contient des informations sur chaque nœud du cluster. Vous pouvez récupérer ces informations à l'aide des `ListActiveNodes` méthodes et `ListAllNodes`.
