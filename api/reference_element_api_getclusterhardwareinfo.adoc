...
[role="lead"]
Vous pouvez utiliser la `GetClusterHardwareInfo` méthode pour récupérer l'état du matériel et les informations de tous les nœuds Fibre Channel, nœuds iSCSI et disques du cluster. Cela comprend généralement les fabricants, les fournisseurs, les versions et d'autres informations d'identification du matériel associé.
