...
[role="lead"]
Vous pouvez utiliser `ListActiveVolumes` la méthode pour obtenir la liste des volumes actifs actuellement dans le système. La liste des volumes est triée par ordre VolumeID et peut être renvoyée en plusieurs parties (pages).
