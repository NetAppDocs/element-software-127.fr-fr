...
[role="lead"]
L'interface utilisateur Web d'Element utilise `DeleteSnapMirrorRelationships` la méthode pour supprimer une ou plusieurs relations SnapMirror entre un noeud final source et un noeud final de destination.
