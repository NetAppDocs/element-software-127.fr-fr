...
[role="lead"]
Vous pouvez utiliser `ListServices` la méthode pour répertorier les informations de services pour les nœuds, les lecteurs, le logiciel actuel et d'autres services exécutés sur le cluster.
