...
[role="lead"]
Vous pouvez utiliser la `ListSyncJobs` méthode pour obtenir des informations sur les tâches de synchronisation qui s'exécutent sur un cluster de stockage Element. Cette méthode renvoie des informations sur les tâches de synchronisation par tranche, clone, bloc et distant.
