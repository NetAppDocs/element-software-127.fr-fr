...
[role="lead"]
Vous pouvez utiliser la `ListVirtualVolumeBindings` méthode pour obtenir une liste de tous les volumes virtuels du cluster liés aux terminaux du protocole.
