...
| `https://[IP address]:442` | Depuis l'interface utilisateur par nœud, accédez aux paramètres réseau et de cluster et utilisez les tests et utilitaires du système. link:../storage/task_per_node_access_settings.html["En savoir plus ."] 
...
| `https://[management node IP address]:9443` | Enregistrez le package du plug-in vCenter dans le client Web vSphere. link:https://docs.netapp.com/us-en/vcp/vcp_task_getstarted.html["En savoir plus ."^] 
|===
