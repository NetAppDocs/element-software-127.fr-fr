...
* Si vous ajoutez plusieurs nœuds de stockage, vous avez lu et compris les limites de la link:../concepts/concept_intro_clusters.html#authoritative-storage-clusters["Cluster faisant autorité"]prise en charge de et de plusieurs clusters de stockage.
+
