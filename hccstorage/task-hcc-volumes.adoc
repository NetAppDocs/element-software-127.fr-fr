...
+
Voir les informations sur link:../concepts/concept_solidfire_concepts_volume_access_groups.html["groupes d'accès de volume"].
...
+
Voir les informations sur link:../concepts/concept_solidfire_concepts_accounts_and_permissions.html#user-accounts["Comptes utilisateurs du système de stockage 100 % Flash SolidFire"].
...
+
Voir les informations sur link:../concepts/concept_data_manage_volumes_solidfire_quality_of_service.html#qos-performance.html["Performances et règles de QoS"].
