...
TIP: Voir link:../media/hseries_isi.pdf["affiche"^]pour une représentation visuelle des instructions.
...
. Saisissez les informations requises dans la fenêtre **Créer un nouveau cluster**. Pour link:../setup/concept_setup_overview.html["présentation de l'installation"^]plus d'informations, reportez-vous à la section.
